    ...
    let data = [
        {
          ...
          content: "Rapidly assess knowledge of every maths skill taught in past year levels",
        ...
        },
        {
          ...
          content: "Guiding study using information on current understanding, making new learning easy",
            ...
            <div className="tools-Heading">
                ...
                {data.map((element,index )=> {
                      ...
                      <div className="tools-card-data">
                          <img className="tools-card-number" src={element.image}></img>
                          <div className="tools-card-heading"><span>{element.heading}</span></div>
                          <span className="tools-card-content">{element.content}</span>
